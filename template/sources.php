...
'.$th.'
		...
		if(!empty($a)){
			...
			foreach($a as $domain){
				...
				$td = "<td style=\"white-space:nowrap;text-align:left;\"><a style=\"text-decoration:none;padding-left:5px;\" title=\"View\" target=\"_blank\" href=\"//$domain\">&#10003;</a><a style=\"text-decoration:none;padding-left:5px;\" title=\"Countries\" href=\"$admin_page?q=countries&g=$g_id$st&d=$domain&t=$table\">&#9872;</a><a style=\"text-decoration:none;padding-left:5px;\" title=\"Log\" href=\"$admin_page?q=log&g=$g_id$st&d=$domain&t=$table\">&#9783;</a><a style=\"padding-left:15px;\" href=\"$admin_page?q=sources&g=$g_id$st&d=$domain&t=$table\">$domain</a></td>
...
<script type="text/javascript">
	  ...
	  function init () {drawChart(); drawChart_se();}
      function drawChart(){
