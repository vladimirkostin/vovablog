...
if($s == '' && $q != 's_create' && $q != 'editor'){
	...
	if(isset($_GET['g']) && !empty($_GET['g'])){$g_get = $_GET['g'];}
	else{$g_get = '';}
...
<div class="item">'.$trans['group']['g3'].'<br><input name="g_name" type="text" value="'.$g_name.'" maxlength="100"></div>
<div class="item">'.$trans['group']['g4'].'<br><input name="g_id" type="text" value="'.$g_id.'" maxlength="100"></div>
...
<div class="item">'.$trans['group']['g6'].'<br><textarea name="g_out" rows="4">'.$g_out.'</textarea><br></div>
<div class="item">'.$trans['group']['g16'].'<br><textarea name="g_curl" rows="3">'.$g_curl.'</textarea><br></div>
...
<div class="item"><span>'.$trans['group']['g8'].'</span> <input style="max-width:30px; width:100%;" name="g_uniq_time" type="text" value="'.$g_uniq_time.'" size="1" maxlength="20"> <span>h.</span><br></div>
<div class="item"><input class="checkbox" type="checkbox"'; if($g_firewall == 1){echo ' checked="checked"';} echo ' name="g_firewall"> <span>'.$trans['group']['g14'].'</span> <input style="max-width:30px; width:100%;" name="g_f_queries" type="text" value="'.$g_f_queries.'" size="1" maxlength="20"> <span>'.$trans['group']['g15'].'</span> <input style="max-width:30px; width:100%;" name="g_f_time" type="text" value="'.$g_f_time.'" size="1" maxlength="20"> <span>h.</span><br></div>
<div class="item"><input class="checkbox" type="checkbox"'; if($g_save_keys == 1){echo ' checked="checked"';} echo ' name="g_save_keys"> <span>'.$trans['group']['g9'].'</span><br></div>
<div class="item"><input class="checkbox" type="checkbox"'; if($g_save_keys_se == 1){echo ' checked="checked"';} echo ' name="g_save_keys_se"> <span>'.$trans['group']['g13'].'</span><br></div>
<div class="item"><input class="checkbox" type="checkbox"'; if($g_log == 1){echo ' checked="checked"';} echo ' name="g_log"> <span>'.$trans['group']['g10'].'</span><br></div>
<div class="item"><input class="checkbox" type="checkbox"'; if($g_status == 1){echo ' checked="checked"';} echo ' name="g_status"> <span>'.$trans['group']['g11'].'</span><br></div>
<div class="item">
'.$trans['group']['g12'].'<br>
